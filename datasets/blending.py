"""
reference: https://github.com/muzairkhattak/ViFi-CLIP/blob/main/datasets/blending.py
"""
    ...
    def __call__(self, imgs, label, **kwargs):
        ...
        Returns:
            ...
            mixed_label (torch.Tensor): Blended soft labels, float tensor with
                ...
                [0, 1].
        """
        one_hot_label = one_hot(label, num_classes=self.num_classes, on_value=self.on_value, off_value=self.off_value, device=label.device) # ex. [0.002, 0.002, ..., 0.902, ..., 0.002]
